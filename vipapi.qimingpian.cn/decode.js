...
function o(e, t, i, n, a, o) {
    ...
    $ = (function (e) {
      for (
        var t,
          ...
          y = e.length > 8 ? 3 : 1,
          b = new Array(32 * y),
          C = new Array(0, 0, 1, 1, 1, 1, 1, 1, 0, 1, 1, 1, 1, 1, 1, 0),
          _ = 0,
          w = 0,
          k = 0;
        k < y;
        ...
        for (var A = 0; A < C.length; A++)
          C[A]
            ? ((x = (x << 2) | (x >>> 26)), (T = (T << 2) | (T >>> 26)))
            : ((x = (x << 1) | (x >>> 27)), (T = (T << 1) | (T >>> 27))),
            (T &= -15),
            (t =
              a[(x &= -15) >>> 28] |
              o[(x >>> 24) & 15] |
  ...
  for (
    ...
    for (
      ...
      for (y = p[c + 1], b = p[c + 2], s = p[c]; s != y; s += b)
        (l = h ^ $[s]),
          (d = ((h >>> 4) | (h << 28)) ^ $[s + 1]),
          (r = u),
          (u = h),
...
function my_decode(str) {
  return o("5e5062e82f15fe4ca9d24bc5", s(str), 0, 0, "012345677890123", 1);
}
